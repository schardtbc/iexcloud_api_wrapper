...
type timePeriod = "1d" | "1m" | "3m" | "6m" | "ytd" | "1y" | "2y" | "5y" | "dynamic" | "max" | "date";
...
export const history = async (
  ...
  const intraday = ((!chartByDay && date) || period === '1d')
      ? true
      : false;
  ...
  return data.map((o: KVP) => !intraday
          ? new EndOfDay({ ...o, symbol })
          : new Intraday({ ...o, symbol })
  );
};